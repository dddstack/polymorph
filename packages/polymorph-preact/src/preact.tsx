...
import type { ComponentProps as PreactComponentProps, JSX } from "preact";
...
>(
  ...
  forwardRef(({ as, children, ...rest }: ComponentProps<AsType> & any, ref) =>
    createElement(as ?? asType, { ref, ...transformer(rest) }, children)
  );
